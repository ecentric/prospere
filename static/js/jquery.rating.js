...
;(function($){
	$.rating = function(e, opt){
        ...
        this.val = parseFloat($("input[name='mark']",e).val()) || parseFloat(this.options.mark);
		...
		this.votes = parseInt($("input[name='count_vote']",e).val()) || parseInt(this.options.votes);
		this.voteID = $("input[name='id']",e).val() || '';
		this.csrf = $("input[name='csrfmiddlewaretoken']",e).val();
    ...
    $r.fn.extend({
    	...
    	init: function(){
    		...
    		this.render();
			this.options.count_changed(this.votes);
    	...
    	send: function(score){
    		...
    		$.ajax({
    			...
    			data:{csrfmiddlewaretoken:this.csrf,id:this.voteID,score:score},
                dataType: 'json',
    			success: function(data){
		            if(data.state == 'OK') {
		              self.votes++; 
		              self.options.count_changed(self.votes);
		              self.set();
		            }  
                    else{
                        self.reset();
